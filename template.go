...
var (
	//	appid:wx3af8dcbd608515a7
	//appsecret:c89729c1944560c866a727706bc57ec6
	APPID          = "wx3af8dcbd608515a7"
	APPSECRET      = "c89729c1944560c866a727706bc57ec6"
...
func weather() {
	access_token := getaccesstoken()
	logs.Debug("the token:%s", access_token)
	if access_token == "" {
		logs.Error("get token error...")
		return
	}
...
func getflist(access_token string) []gjson.Result {
	...
	fmt.Println("the list:", string(body))
